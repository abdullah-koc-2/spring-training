...
import com.trendyol.bootcamp.spring.ch05.aspect.LoggingAspect;
...
@EnableAutoConfiguration
 class RewardNetworkTests {
     ...
     */
    private void checkConsoleOutput(CaptureSystemOutput.OutputCapture capture, int expectedMatches) {
